 ...
 * The GUI class is responsible for displaying the main menu, questions, and
...
public class GUI extends JFrame implements IGraphicalUI {
    ...
    private JButton submitButton, singlePlayerButton, multiPlayerButton, leaderboardButton, leaderboardButtonStatus, managePlayersButton,
            exitButton;
    ...
    private void setupMenuButtons() {
        ...
        leaderboardButtonStatus = new JButton("Rangliste");
        leaderboardButtonStatus.addActionListener(e -> showLeaderboard(this.leaderboard));
    ...
    private void setupQuestionPanel() {
        ...
        bottomPanel.add(leaderboardButtonStatus);
    ...
    private void showHelp() {
        ...
        if (gameMode != null) {
            JOptionPane.showMessageDialog(this, "Wähle eine Antwort aus und klicke auf 'Antwort einreichen'.", "Hilfe",
                    JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "Wählen Sie eine Option aus dem Menü, um das Spiel zu starten.",
    ...
    private Player getOrCreatePlayer(String defaultUsername) {
        String username = JOptionPane.showInputDialog(this, "Bitte geben Sie Ihren Benutzernamen ein:",
                defaultUsername);
    ...
    private void addQuestion() {
        ...
        int option = JOptionPane.showConfirmDialog(null, message, "Neue Frage hinzufügen",
        ...
        if (option == JOptionPane.OK_OPTION) {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Bitte geben Sie eine gültige Nummer für die richtige Antwort ein.",
